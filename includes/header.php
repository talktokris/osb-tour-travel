...
<?php if (!empty($_SESSION['user_id'])): ?>
    ...
    $homeNavPages = ['home', 'home_agent_search', 'home_browse', 'home_supplier_bookings', 'home_cancel_report'];
    ...
    $driverNavPages = ['driver', 'driver_assign', 'driver_notification'];
    $isDriverNav = in_array($currentPage, $driverNavPages, true);
    ...
    <header style="position:fixed;top:0;left:0;right:0;z-index:20;background:#ffffff;border-bottom:1px solid #d7dee7;box-shadow:0 6px 20px rgba(15,23,42,0.10);">
        <div style="max-width:1400px;margin:0 auto;padding:10px 20px;display:flex;align-items:center;justify-content:space-between;gap:12px;">
            ...
            <div style="display:flex;align-items:center;gap:10px;white-space:nowrap;font-size:12px;flex-wrap:wrap;justify-content:flex-end;">
                ...
                <?php if ($hasAgentCookie): ?>
                    <a href="index.php?page=agent_login&amp;login_id=logout" style="padding:4px 10px;border-radius:999px;background:#fff1f2;color:#9f1239;font-weight:600;border:1px solid #fecdd3;text-decoration:none;">Agent logout</a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div style="background:linear-gradient(90deg,#0c4a8a 0%,#0b77bb 55%,#0a94c8 100%);border-top:1px solid rgba(255,255,255,0.30);box-shadow:inset 0 1px 0 rgba(255,255,255,0.18);">
            <nav style="max-width:1400px;margin:0 auto;padding:8px 16px;display:flex;align-items:center;justify-content:center;gap:4px;white-space:nowrap;overflow-x:auto;">
                ...
                <a href="index.php?page=driver" style="height:34px;padding:0 12px;display:inline-flex;align-items:center;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none;<?= $isDriverNav ? 'background:#ffffff;color:#0c4a8a;box-shadow:0 4px 10px rgba(15,23,42,0.20);' : 'color:#ffffff;' ?>">Driver</a>
                ...
                <a href="index.php?page=sms" style="height:34px;padding:0 12px;display:inline-flex;align-items:center;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none;<?= $isSmsNav ? 'background:#ffffff;color:#0c4a8a;box-shadow:0 4px 10px rgba(15,23,42,0.20);' : 'color:#ffffff;' ?>">SMS</a>
