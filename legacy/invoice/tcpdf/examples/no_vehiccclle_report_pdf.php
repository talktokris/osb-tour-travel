...
if (isset($_GET['no_vehiccclle'])) {$tour_came = $_GET['no_vehiccclle'];
...
$header_table='<table>
<tr><td colspan="2" align="center"><h2>Vehicle No. Report</h2> </td></tr>
<tr><td width="60"><strong>Vehicle No.  </strong></td><td>: '.$search_word.'</td></tr>
...
$query_select = "SELECT  *  FROM file_entry WHERE  vehicle_no  = '$search_word' AND date BETWEEN '$from_date' AND '$to_date' ORDER BY date DESC";
		$Num=1;
