...
if (is_file($osbLogo)) {
	$pdf->Image($osbLogo, 14, 16, 70, 0, 'JPG');
}
...
<tr><td width="500">'.$service_date.' '.$service.'.'.$vehicle_type.'</td><td width="50">'.$no_of_vachile.'</td><td width="50">'.$selling_price.'</td><td width="70"> RM '.$selling_price_total.'</td></tr>';
