...
$header_table='<table>
<tr><td colspan="2" align="center"><h2>City Report.</h2> </td></tr>
<tr><td width="60"><strong>City Name  </strong></td><td>: '.$search_word.'</td></tr>
...
$query_select = "SELECT  *  FROM file_entry WHERE  from_city  = '$search_word' AND date BETWEEN '$from_date' AND '$to_date' ORDER BY date DESC";
		$Num=1;
