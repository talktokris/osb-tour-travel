...
if (isset($_GET['supplier'])) {$supplier_came = $_GET['supplier'];
$supplier_came_part=explode('|', $supplier_came);


$search_word=$supplier_came_part[0]; // $b=$search_word_part[1];
$from_date=$supplier_came_part[1];
$to_date=$supplier_came_part[2];
...
$header_table='<table>
<tr><td colspan="2" align="center"><h2>Supplier Report</h2> </td></tr>
<tr><td width="60"><strong>Supplier Name  </strong></td><td>: '.$search_word.'</td></tr>
