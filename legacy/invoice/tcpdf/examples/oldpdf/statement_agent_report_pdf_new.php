...
///////////////////
$header_table='<table>
<table width="945" colspan="2" border="1" bgcolor="#cccccc">
  <tr>
    <td colspan="2" align="center"><h2>Statement Agent Report.</h2> </td>
  </tr>
  <tr>
...
$rowHeader= '<table  border="1"  cellpadding="5" ><tr bgcolor="#cccccc"><td>S.N</td><td>Invoice/File No.</td><td>Issue Date</td><td>Due Date</td><td>From Date</td><td>Guest Name</td><td>Description</td><td>Qty</td><td>Night(s)</td><td>Price</td><td>Item Amount</td><td>Total Discount</td><td>Total Invoice</td><td>Paid</td><td>Balance</td><td>Acc. Status</td><td>Status</td><td>UserCreate</td></tr>';

$query_select = "SELECT  *  FROM file_entry WHERE  agent_name  = '$search_word' AND date BETWEEN '$from_date' AND '$to_date' ORDER BY date DESC";
		$Num=1;
...
<td>".$Num."</td><td>".$row['file_no']."</td><td>".$row['date']."</td><td>".$row['supplier_name']."</td><td>".$row['from_location']."</td><td>".$row['to_location']."</td><td>".$row['first_name']."</td><td>".$row['no_of_pax']."</td><td>".$row['service_date']."</td><td>".$row['driver_name']."</td><td>".$row['vehicle_no']."</td><td>".$row['vehicle_type']."</td><td>".$row['service_type']."</td><td>".$row['service_type']."</td><td>".$row['service_type']."</td><td>".$row['service_type']."</td><td>".$row['service_type']."</td><td>".$row['driver_name']."</td><td>".$row['service_type']."</td>
</tr>";
