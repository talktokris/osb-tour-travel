...
$header_table='<table>
<tr><td colspan="2" align="center"><h2>Tour Type Report</h2> </td></tr>
<tr><td width="60"><strong>Tour Name</strong></td><td>: '.$search_word.'</td></tr>
...
$query_select = "SELECT  *  FROM file_entry WHERE  service_cat  = '$search_word' AND date BETWEEN '$from_date' AND '$to_date' ORDER BY date DESC";
		$Num=1;
