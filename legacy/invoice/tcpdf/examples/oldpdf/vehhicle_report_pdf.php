...
if (isset($_GET['vehhicle'])) {$vehhicle_came = $_GET['vehhicle'];
$vehhicle_came_part=explode('|', $vehhicle_came);


$search_word=$vehhicle_came_part[0]; // $b=$search_word_part[1];
$from_date=$vehhicle_came_part[1];
$to_date=$vehhicle_came_part[2];
...
$header_table='<table>
<tr><td colspan="2" align="center"><h2>Vehicle Type Report</h2> </td></tr>
<tr><td width="60"><strong>Vehicle Name</strong></td><td>: '.$search_word.'</td></tr>
...
$query_select = "SELECT  *  FROM file_entry WHERE  vehicle_type  = '$search_word' AND date BETWEEN '$from_date' AND '$to_date' ORDER BY date DESC";
		$Num=1;
