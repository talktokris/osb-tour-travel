        ...
        <div class="space-y-4">
            ...
            <div class="card bg-base-100 shadow-xl border border-base-300">
                <div class="card-body space-y-4">
                    <?php $usersAction = 'password'; require __DIR__ . '/menu-top.php'; ?>
                            ...
                            <tbody>
                                <?php foreach ($users as $row): ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-xs btn-primary btn-outline" href="index.php?page=users_password_form&id=<?= (int) $row['Userid'] ?>">Change Password</a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
