...
<div class="invoice-form-fieldstack">
  <label class="form-control w-full max-w-md">
    <span class="label-text text-xs font-semibold">Search by Agent</span>
    <input type="text" name="search_agent" class="input input-bordered input-sm w-full bg-white" value="<?= h((string) ($fv['search_agent'] ?? '')) ?>" list="invoice-agents">
    <datalist id="invoice-agents"><?php foreach ($agents as $a): ?><option value="<?= h($a) ?>"><?php endforeach; ?></datalist>
  </label>
  <label class="form-control w-full max-w-md">
