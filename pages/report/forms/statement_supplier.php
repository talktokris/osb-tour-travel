...
<div class="report-form-fieldstack">
    <label class="form-control w-full max-w-md">
        <span class="label-text text-xs font-semibold">Report by Supplier</span>
    ...
    <p class="text-xs text-base-content/70 max-w-xl">Optional range filters file rows by entry date (<code class="text-xs">date</code>). Totals use invoice create dates in range when both dates are set.</p>
