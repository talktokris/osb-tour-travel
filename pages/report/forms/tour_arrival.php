...
<div class="report-form-fieldstack">
    <label class="form-control w-full max-w-md">
        ...
        <select name="search_supplier" class="select select-bordered select-sm w-full bg-white">
            <option value="">All suppliers</option>
            <?php
            $selS = (string) ($fv['search_supplier'] ?? '');
