...
<div class="report-form-fieldstack">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl">
        <label class="form-control w-full">
            ...
            <input type="text" name="from_date" id="report-from-date" value="<?= h((string) ($fv['from_date'] ?? '')) ?>"
        ...
        <label class="form-control w-full">
            ...
            <input type="text" name="to_date" id="report-to-date" value="<?= h((string) ($fv['to_date'] ?? '')) ?>"
                   class="input input-bordered input-sm w-full bg-white js-report-date-input" placeholder="dd-mm-yyyy" autocomplete="off">
        </label>
    </div>
</div>
