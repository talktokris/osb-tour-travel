...
<div class="flex gap-6 w-full">
    ...
    <main class="flex-1 px-4">
        <div class="space-y-4">
            <?php $breadcrumbCurrent = 'Home'; require __DIR__ . '/../../includes/breadcrumb.php'; ?>
            ...
            <div class="card bg-base-100 shadow-xl border border-base-300">
                <div class="card-body">
                    ...
                    <p class="text-base-content/70 text-sm mt-4">
                        ...
                        Use the menu on the left for navigation. Dashboard stats will appear here as we migrate features from the legacy system.
                    </p>
                </div>
            </div>
        </div>
